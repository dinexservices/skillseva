            ...
            <div className="max-w-content mx-auto px-4 md:px-8">
                <div className="grid gap-16">
                    ...
                    <div className="grid gap-6 max-w-[1200px] text-center mx-auto justify-items-center">
                        ...
                        <div className="mt-2 max-w-[800px] w-full">
                            <p className="text-[1.09rem] leading-[1.6] text-text-secondary m-0">
                            ...
                            <div className="mt-8">
                                {activeTab === 'On-going' && (
                                    ongoing.length > 0 ? (
                                        ...
                                        <div className="text-center py-20 bg-gray-50 rounded-2xl border border-gray-100">
                                            <p className="text-gray-500 font-medium">No ongoing cohorts available at the moment.</p>
                                        </div>
                                    )
                                )}
                                ...
                                {activeTab === 'Upcoming' && (
                                    upcoming.length > 0 ? (
                                        ...
                                        <div className="text-center py-20 bg-gray-50 rounded-2xl border border-gray-100">
                                            <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gray-100/50 text-3xl mb-4">
                                                🚀
                                            </div>
                                            <p className="text-gray-500 font-medium text-lg">No upcoming cohorts scheduled yet.</p>
                                            <p className="text-gray-400 mt-2 text-sm">Check back soon for new program announcements!</p>
                                        </div>
                                    )
                                )}
                            </div>
